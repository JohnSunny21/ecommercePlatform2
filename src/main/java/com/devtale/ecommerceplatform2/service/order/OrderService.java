...
import com.devtale.ecommerceplatform2.model.OrderItem;
import com.devtale.ecommerceplatform2.model.Product;
import com.devtale.ecommerceplatform2.repository.OrderRepository;
import com.devtale.ecommerceplatform2.repository.ProductRepository;
import com.devtale.ecommerceplatform2.service.cart.CartService;
...
public class OrderService implements IOrderService {
    ...
    private List<OrderItem> createOrderItems(Order order, Cart cart){
        return cart.getItems().stream().map(cartItem -> {
            ...
            return new OrderItem(order.getOrderId(),
