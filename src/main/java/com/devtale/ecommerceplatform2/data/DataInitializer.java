package com.devtale.ecommerceplatform2.data;

import com.devtale.ecommerceplatform2.exceptions.ResourceNotFoundException;
import com.devtale.ecommerceplatform2.model.Role;
import com.devtale.ecommerceplatform2.model.User;
import com.devtale.ecommerceplatform2.repository.RoleRepository;
...
public class DataInitializer implements ApplicationListener<ApplicationReadyEvent> {
    ...
    private void createDefaultAdminIfNotExists(){
        ...
        for (int i = 1; i <=2; i++){
            ...
            userRepository.save(user);
            System.out.println("Default admin user " + i + " created succcessfully");
        }
    }
